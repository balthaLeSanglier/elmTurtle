...
var $author$project$Main$initialModel = {userInput: ''};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$placeholder('Entrez du texte ici'),
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Vous avez entré : ' + model.userInput)
					]))
			]));
};
